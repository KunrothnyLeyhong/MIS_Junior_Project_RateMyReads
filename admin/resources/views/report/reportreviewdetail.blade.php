...
<div class="flex-1 bg-[#B5E2FF] p-6">
    <div class="bg-white rounded-lg shadow-lg p-6 max-w-4xl mx-auto">
        ...
        @endphp
            <div class="mb-6">
                <a href="{{ route('report.reportreview') }}" class="inline-block bg-blue-300 text-gray-800 px-4 py-2 rounded shadow hover:bg-blue-400 transition">
                    ←
                </a>
            </div>
        ...
        <a href="{{ route('report.reportreview.reject', $report->id) }}" class="inline-block bg-red-500 text-white px-4 py-2 rounded hover:bg-red-600 ml-3">
            Reject
        </a>
    </div>
</div>
